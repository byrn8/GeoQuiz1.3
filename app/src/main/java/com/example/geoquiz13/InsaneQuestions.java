...
public class InsaneQuestions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(v -> {
            ...
            if("option1" == currentQuestion.getAnswer() && isRunning == true) {
                ...
                Toast.makeText(InsaneQuestions.this, "Correct", Toast.LENGTH_SHORT).show(); //output correct toast
                quizScore++;
                ...
                Toast.makeText(InsaneQuestions.this, "Incorrect", Toast.LENGTH_SHORT).show(); //output incorrect toast
    ...
    private void addQuestion() {
        questionList.add(new QuestionTemplate("What is the capital of Mali?", "Conakry", "Segou", "Bamako", "Dakar", "option3"));
        questionList.add(new QuestionTemplate("What is the capital of Malawi?", "Zomba", "Mzuzu", "Lilongwe", "Tete", "option3"));
        questionList.add(new QuestionTemplate("What is the capital of Fiji?", "Nadi", "Suva", "Lautoka", "labassa", "option2"));
        questionList.add(new QuestionTemplate("What is the capital of Suriname?", "George Town", "Paramaribo", "Moengo", "Arima", "option2"));
        questionList.add(new QuestionTemplate("What is the capital of Uzbekistan?", "Ashgabat", "Samarkand", "Bukhara", "Tashkent", "option4"));
        questionList.add(new QuestionTemplate("What is the capital of Albania?", "Tirana", "Vlore", "Skopje", "Sarajevo", "option1"));
        questionList.add(new QuestionTemplate("What is the capital of Togo?", "Kumasi", "Tema", "Kara", "Lome", "option4"));
        questionList.add(new QuestionTemplate("What is the capital of Vanuatu?", "Port Vila", "Port Olry", "Port Lautour", "Ambae", "option1"));
        questionList.add(new QuestionTemplate("What is the capital of Laos?", "Haiphong", "Phonsavan", "Pakse", "Vientiane", "option4"));
        questionList.add(new QuestionTemplate("What is the capital of Burundi?", "Bukavu", "Ngozi", "Bujumbura", "Gitega", "option3"));
    }
}